...
import ShopBasket from 'mdi-react/BasketIcon';
import mdiClipboardListOutline from 'mdi-react/ClipboardListIcon';
...
import ListRequisitionPage from './ListRequisition';
...
const AdminPage = memo((props: {}) => {
  ...
  const [menu] = useState([
    ...
    { path: '/requisition', display: 'Realizar Pedidos', icon: ShopBasket },
    { path: '/list', display: 'Lista de Pedidos', icon: mdiClipboardListOutline }
  ]);
        ...
        <Drawer menu={menu}>
          <main ref={mainContent} className={classes.content}>
            <Switch>
              ...
              <Route path='/requisition' component={RequisitionPage} />
              <Route path='/list' component={ListRequisitionPage} />
